var onload_script = function() {
	...
	function setup_device() {
		frappe.call( {
			method: "next_crm.api.api.generate_access_token",
			callback: (data) => {
	...
	function update_call_log(conn, status="Completed") {
		...
		frappe.call({
			"method": "next_crm.api.api.update_call_log",
			"args": {
	...
	function call_screen(conn) {
		frappe.call({
			type: "GET",
			method: "next_crm.api.api.get_contact_details",
			args: {
